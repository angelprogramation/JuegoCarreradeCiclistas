...
//funcion para cargar imagenes,animaciones y sonido
function preload(){
...
//funcion en donde se definen las propiedades del  juego
function setup(){
...
//establece el colisionador para el mainCyclist
 ...
 mainCyclist.setCollider("rectangle",0,0,mainCyclist.width-350,mainCyclist.height-400) 
...
redCG = new Group();
 ...
 //fundion draw para iniciar el juego
function draw() {
  background(0);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    //aquí el código para mostrar la instrucción de reinicio del juego, en forma de texto
    textSize(20);
    text("Presiona la tecla de Flecha hacia Arriba para reiniciar el juego",300,200) 
  
  
    //velocidades de objjetos del juego
    path.velocityX = 0;
